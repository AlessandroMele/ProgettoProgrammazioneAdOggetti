...
public class Filters {
	...
	/**
	 * This method tries to take value "max" from JSONObject length If it fails, it
	 * set by default value 10000
	 * 
	...
	/**
	 * This method tries to take value "min" from JSONObject length If it fails, it
